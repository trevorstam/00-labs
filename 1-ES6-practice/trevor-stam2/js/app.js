...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT --> The previous line threw an error because 'let' is limited to block, statement or expression.
  //In this case the variable rando is defined within the function but is used outside the function in a console log. Hence the error. 
  console.log(viewed);
